...
class module {
  ...
  public:
    ...
    void add_son_position(std::string son_name, int position) {
        this->sons_map.emplace(son_name, position);
    };
    void edit_position(std::string son_name, int new_position) {
        this->sons_map.at(son_name) = new_position;
    };
