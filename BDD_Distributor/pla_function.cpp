...
pla_function::get_vars_from_fun(int function_value) {
...
void
pla_function::add_line(std::string new_vars, int value) {
    this->add_variables(new_vars);
    this->add_fun_value(value);
}

void
pla_function::print_function() {
...
std::vector<std::vector<std::string>*>*
pla_function::sort_by_position(int position) {
    std::vector<std::vector<std::string>*>* sorted = new std::vector<std::vector<std::string>*>();
...
void
pla_function::input_variables(std::vector<std::vector<std::string>*>* additional_vars, int position,
                              int function) {
...
int
pla_function::get_fun_value(std::string indexed_variables) {
...
std::string
pla_function::replace_char(std::string before, int position, std::string input) {
